...
export default function App() {
  ...
  const handleAnalyze = async (type: 'ISC' | 'EFS' | 'GENERAL') => {
    ...
    try {
      // BOLT OPTIMIZATION: Parallelize AI extraction and database saves for multiple images.
      // Reduces wait time from O(N) to approximately O(max(latency)) by firing requests concurrently.
