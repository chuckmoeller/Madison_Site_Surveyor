                    ...
                    <div className="relative">
                      <textarea
                        ...
                        onChange={(e) => {
                          ...
                          if (val.length <= 500) {
                            const updated = { ...currentRecord, notes: val };
                            setCurrentRecord(updated);
                            saveSurvey(updated as SurveyRecord);
                          }
                        }}
                        placeholder="Add site observations..."
                        className="w-full h-24 bg-black border border-zinc-700 rounded-lg px-4 py-2 pr-12 text-sm focus:border-emerald-500 outline-none transition-colors resize-none"
                      />
                      <div className="absolute bottom-2 right-3 text-[10px] text-zinc-500 font-mono pointer-events-none">
              ...
              <div className="space-y-3">
                {history.map(record => (
                  <button
                    ...
                    className="w-full text-left p-4 bg-zinc-900 border border-zinc-800 rounded-xl flex items-center gap-4 cursor-pointer hover:border-zinc-600 transition-colors"
                  >
                ...
                {history.length === 0 && (
                  <div className="py-12 text-center text-zinc-500 space-y-6">
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-2 px-6 py-3 bg-emerald-600 hover:bg-emerald-500 text-white font-bold rounded-xl transition-all active:scale-95"
                    >
